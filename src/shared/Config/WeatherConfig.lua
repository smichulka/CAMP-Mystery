...
local byId: { [WeatherId]: WeatherDefinition } = {
	...
	BloodMoon = definition({
		...
		lightningMinSeconds = 0,
		lightningMaxSeconds = 0,
		nightAmbientOverride = Color3.fromRGB(52, 16, 20),
		nightOutdoorAmbientOverride = Color3.fromRGB(70, 18, 24),
		nightFogColorOverride = Color3.fromRGB(64, 20, 26),
		nightAtmosphereColorOverride = Color3.fromRGB(142, 44, 48),
		nightAtmosphereDecayOverride = Color3.fromRGB(58, 12, 16),
