...
local counselors: { CounselorDefinition } = {
	{
		...
		description = "A decisive longtime director who knows every staff route and emergency procedure.",
		isAdult = true,
		bravery = 0.86,
		reliability = 0.82,
		schedule = {
	...
	},
	{
		...
		description = "A calm first-aid lead who notices injuries, timing, and changes in behavior.",
		isAdult = true,
		bravery = 0.58,
		reliability = 0.9,
		schedule = {
	...
	},
	{
		...
		description = "A practical trail expert who reads tracks well but dislikes crowded discussions.",
		isAdult = true,
		bravery = 0.78,
		reliability = 0.76,
		schedule = {
	...
	},
	{
		...
		description = "An observant activities lead with a strong memory for clothing, voices, and small details.",
		isAdult = true,
		bravery = 0.46,
		reliability = 0.72,
		schedule = {
	...
	},
	{
		...
		description = "A methodical science counselor who trusts instruments but checks contamination carefully.",
		isAdult = true,
		bravery = 0.62,
		reliability = 0.94,
		schedule = {
	...
	},
	{
		...
		description = "A friendly logistics lead who knows equipment checkout records and keeps people moving.",
		isAdult = true,
		bravery = 0.52,
		reliability = 0.8,
		schedule = {
